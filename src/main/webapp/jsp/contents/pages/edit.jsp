...
<div class="container">
	<div class="row">
		<div class="col-lg-12">
			<form action="/<c:out value="${module}" />?action=<c:out value="${action}" />&id=<c:out value="${site.getId()}" />" method="post" class="form">
				<div class="form-title">Edycja strony</div>
				<div class="form-group">
					...
					<div class="label">Modyfikacja: <b><c:out value="${fn:substringBefore(site.getModified(), '.')}" /></b></div>
				</div>
				<hr>
